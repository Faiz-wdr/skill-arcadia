...
export function IconCheckCircle({ size = 18, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconLock({ size = 22, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconEmpty({ size = 36, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSort({ size = 14, className = '', order = null }) {
  if (order === 'asc') {
    return (
      <svg
        width={size}
